...
public class SlidingDrawerManager implements OnClickListener,
		OnSeekBarChangeListener, OnDrawerOpenListener,
		OnDrawerCloseListener {

	private WhiteMusicSlidingDrawer mSliding;
	...
	private View mView;
	private WhiteMusicServiceManager mServiceManager;
...
//	private MusicInfo mCurrentMusicInfo;
	...
	private WhiteMusicListAdapter mAdapter;;
...
//	private SPStorage mSp;
	...
	public SlidingDrawerManager(Activity a, WhiteMusicServiceManager sm, View view) {
...
//		view_out = AnimationUtils.loadAnimation(a, R.anim.fade_out);
		...
		mHandler = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				refreshSeekProgress(mServiceManager.getCurrentMusicPosition(),
						mServiceManager.getCurrentMusicDuration());
			}
		};
	}
...
//		}
//		// 取得歌曲同目录下的歌词文件绝对路径
//		String lyricFilePath = MainActivity.lrcPath + "/" + playingSong.musicName
//				+ ".lrc";
...
//		// 取得歌曲同目录下的歌词文件绝对路径
//		String lyricFilePath = MainActivity.lrcPath + "/" + musicName + ".lrc";
//		File lyricfile = new File(lyricFilePath);
//
//		if (lyricfile.exists()) {
//			// 本地有歌词，直接读取
...
//	};
	...
	public void setListViewAdapter(WhiteMusicListAdapter adapter) {
		mAdapter = adapter;
	}
